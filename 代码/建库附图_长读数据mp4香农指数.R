...
df_wide <- data.frame(
  ...
  without_pretreatment = c(2.926814668, 2.113897228, 3.955010534, 3.648238615, 4.082728826),
  with_pretreatment = c(2.912584673, 3.463933703, 4.080720337, 3.909177095, 4.245447126)
)
